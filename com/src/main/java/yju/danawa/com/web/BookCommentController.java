...
public class BookCommentController {
    ...
    @GetMapping
    public List<BookCommentDto> listComments(
    ...
    public BookCommentDto createComment(
            @PathVariable String isbn13,
            @Valid @RequestBody BookCommentCreateRequest request,
            Principal principal
    ) {
        String username = principal != null ? principal.getName() : null;
        return bookCommentService.createComment(isbn13, request.content(), username);
    }
    ...
    public BookCommentLikeToggleResponse toggleLike(
            @PathVariable String isbn13,
            @PathVariable Long commentId,
            Principal principal
    ) {
